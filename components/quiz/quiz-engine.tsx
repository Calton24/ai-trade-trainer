...
export function QuizEngine({ quiz, pathId }: QuizEngineProps) {
  ...
  }, [finished, correctCount, quiz, pathId, recordQuizAttempt])
    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          {pathId && (
            <Button render={<Link href={`/paths/${pathId}`} />}>
              Continue Path
