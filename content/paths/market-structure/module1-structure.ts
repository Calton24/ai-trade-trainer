...
export const marketStructureModule: CourseModule = {
  ...
  lessons: [
    ...
    {
      id: "ms-structure-replay",
      moduleId: MODULE_ID,
      pathId: PATH_ID,
      slug: "structure-replay",
      title: "Structure Replay",
      description:
        "Reveal real candles one at a time — read structure before the full picture is obvious.",
      lessonType: "interactive",
      difficulty: "intermediate",
      order: 7,
      xpReward: 65,
      ...
      estimatedMinutes: 0,
      contentBlocks: [
        { id: "h1", type: "heading", content: "Read It Candle by Candle" },
        {
          id: "p1",
          type: "paragraph",
          content:
            "Static charts teach patterns. Replay teaches intuition. Each drill reveals candles one at a time — the way price actually unfolds. You must classify the trend or predict continuation before the answer is obvious. This is how professionals train: hundreds of partial reads, not one perfect hindsight chart.",
        },
        {
          id: "w1",
          type: "interactive-widget",
          ...
          widget: {
            ...
            prompt: "Replay #1 — reveal the chart, then classify the trend.",
            scenarioKind: "uptrend",
            seed: "ms-replay-uptrend",
            startIndex: 8,
            pauseIndex: 33,
            task: "classify-trend",
            correctTrend: "Uptrend",
            explain:
              "By candle 34 you should see higher highs and higher lows forming — a confirmed uptrend. The four-point read (HL → HH → HL → HH) is enough even without seeing the full move.",
          },
        },
        {
          id: "w2",
          ...
          widget: {
            kind: "structure-replay",
            prompt: "Replay #2 — is this trending or ranging?",
            scenarioKind: "ranging",
            seed: "ms-replay-range",
            startIndex: 8,
            pauseIndex: 32,
            task: "classify-trend",
            correctTrend: "Range",
            explain:
              "The highs and lows overlap without net progress — price is chopping between a ceiling and floor. No trend to follow; professionals stand aside here.",
          },
        },
        {
          id: "w3",
          ...
          widget: {
            kind: "structure-replay",
            prompt:
              "Replay #3 — this was a clean uptrend. It just printed a lower low. What is the market attempting?",
            scenarioKind: "uptrend-reversal",
            seed: "ms-replay-reversal-up",
            startIndex: 10,
            pauseIndex: 36,
            task: "predict-continuation",
            correct: "Reversal",
            explain:
              "The uptrend broke its higher-low sequence with a lower low at the pause point. That's the first structural evidence of a reversal — buyers lost the level they'd been defending.",
          },
        },
        {
          id: "callout1",
          type: "callout",
          content:
            "The goal isn't to guess the future — it's to read what structure is telling you RIGHT NOW with incomplete information. That's exactly what live trading demands.",
          metadata: { variant: "key-idea" },
        },
        {
          id: "sum1",
          type: "summary",
          content:
            "Structure Replay trains partial reads: reveal candles, classify trend, predict continuation — before hindsight makes it easy.",
        },
      ],
    },
    {
      ...
      order: 8,
      xpReward: 60,
      prerequisites: ["ms-structure-replay"],
      estimatedMinutes: 0,
      contentBlocks: [
